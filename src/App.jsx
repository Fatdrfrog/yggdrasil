...
function App() {
  ...
  return (
    <YggdrasilContext.Provider
      value={{ handleSetConditions, handleRemoveTask, conditions }}
    >
      <div className="container">
        {currentTask && <Dialog task={currentTask} />}
                      ...
                      {(conditions.thirdTaskResult === 5 ||
                        ...
                        <div className="sub-tree last">
                          <p>
                            ...
                            You were trying to cross the root, right? Jumped
                            right into that Bai's soldiers ambush, same as us,
                            and that thief over there. Damn you Hunters...
                            <br />
